...
class Cloles9 extends StatefulWidget {
  @override
  State<Cloles9> createState() => _HomePageState();
}

class _HomePageState extends State<Cloles9> {
  int quantity = 1;
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image:
                                    NetworkImage(recommends3[index]['imgUrl']),
                                fit: BoxFit.cover)),
                      ),
                    ],
                  ),
