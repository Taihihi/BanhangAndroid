...
class Cloles12 extends StatefulWidget {
  @override
  State<Cloles12> createState() => _HomePageState();
}

class _HomePageState extends State<Cloles12> {
  int quantity = 1;
    ...
    return ListView(
      ...
      children: [
        Stack(
          children: [
            Column(
                children: List.generate(recently2.length, (index) {
              return Padding(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image: NetworkImage(recently2[index]['imgUrl']),
                                fit: BoxFit.cover)),
                      ),
                    ],
                  ),
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'Price: ${recently2[index]['price']} VND',
                    style: TextStyle(
                      fontSize: 18.0,
                      fontWeight: FontWeight.bold,
                      color: Colors.blue,
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 5.0),
                      Text(
                        '(${recently2[index]['reviews']} reviews)',
                        style: TextStyle(
                          fontSize: 16.0,
                        ),
                      ),
