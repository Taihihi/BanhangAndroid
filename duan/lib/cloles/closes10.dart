...
class Cloles10 extends StatefulWidget {
  @override
  State<Cloles10> createState() => _HomePageState();
}

class _HomePageState extends State<Cloles10> {
  int quantity = 1;
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image:
                                    NetworkImage(recommends4[index]['imgUrl']),
                                fit: BoxFit.cover)),
                      ),
                    ],
                  ),
